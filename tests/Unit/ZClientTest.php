...
it('sends buttons with correct JSON payload to Z-API', function () {
    // Arrange
    Http::fake([
    ...
    Http::assertSent(function ($request) use ($phone, $text, $buttons) {
...
it('handles successful API response (200)', function () {
    // Arrange
    Http::fake([
        '*' => Http::response([
            'success' => true,
...
it('handles 500 error response from API', function () {
    // Arrange
    Http::fake([
        '*' => Http::response([
            'error' => true,
...
it('sends correct instance and token in URL', function () {
    // Arrange
    ...
    // Act
    $client->sendButtons('5511999999999', 'Test', []);
...
it('sends correct button structure for URL type', function () {
    // Arrange
...
it('sends correct button structure for CALL type', function () {
    // Arrange
    Http::fake(['*' => Http::response(['success' => true], 200)]);
